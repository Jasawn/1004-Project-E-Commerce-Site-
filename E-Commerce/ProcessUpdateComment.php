        ...
        <div class="row">
            <div class="col-md-10 offset-md-1 col-lg-12 offset-lg-0">
                ...
                function updateCommentToDB() {
                    global $content, $email, $date, $errorMsg, $success, $commentid;
                    ...
                    if ($conn->connect_error) {
                        ...
                        $stmt = $conn->prepare("UPDATE comments SET Content=?, Date=? WHERE CommentID=?");
                        echo "<script>console.log('connection test 2');</script>";
                        // echo "<p>" . $forumIDU . "</p>";
                        // Bind & execute the query statement:
                        $stmt->bind_param("ssi", $content, $date, $commentid);
